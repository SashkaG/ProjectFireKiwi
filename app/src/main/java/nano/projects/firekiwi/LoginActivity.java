...
/**
 * A login screen that offers login via email/passwor
 * d.
 */
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout phone = (LinearLayout)findViewById(R.id.send);
        LinearLayout verify = (LinearLayout)findViewById(R.id.verify);
        final MaterialEditText code = (MaterialEditText)findViewById(R.id.code);
    ...
    private void Resend(String phoneNumber)//resend code
    {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                phoneNumber,        // Phone number to verify
                120,                 // Timeout duration
